					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "지점 별 차량 구매 오더 이력 차트",
									"targetURL": "#ERzfercarpo-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"ERzfercarpo-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ER.zfercarpo",
									"url": sap.ui.require.toUrl("ER/zfercarpo")
								}
							}
						}
					}
